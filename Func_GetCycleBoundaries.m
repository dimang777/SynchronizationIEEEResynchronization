...
function [Cycle_Boundaries_T, Cycle_Boundaries_Indices] = ...
    Func_GetCycleBoundaries(Signal_T ,Signal, MinInterval)
...
Cycle_Boundaries_T = Signal_T(Cycle_Boundaries_Indices);

if ~iscolumn(Cycle_Boundaries_T)
    Cycle_Boundaries_T = Cycle_Boundaries_T';
end

figure(1); clf; hold on;
plot(Signal_T, Signal_zeros_indices);
plot(Signal_T(2:end), Signal_zeros_indices_diff, 'kx');
